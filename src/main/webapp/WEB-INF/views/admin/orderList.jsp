			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.hukangjin.model.Order o=(com.hukangjin.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.hukangjin.dao.UserDao userDao=new com.hukangjin.dao.UserDao();
						...
						<%
							...
							String paymentType=com.hukangjin.model.Payment.findByPaymentId(con,n);
							 %>
